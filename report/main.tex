...
% ============================================================
\section*{Statement on AI Tools}

AI tools such as search engines and llms were used to gather material and understand concepts. pilot was used as a coding assistant to identify syntax errors during
implementation. Writing, modelling decisions, analysis, and conclusions were reached by author.

% ============================================================
\section*{Reproducibility Statement}

All results are produced by running \texttt{python main.py} from the repository root
with \texttt{requirements.txt} satisfied. The analytic code is fully deterministic.
...
The full source code, figures, and this report are available at:\\
\url{https://github.com/TheAce10/Microservice\_Latency\_Budget\_Modelling}
